  ...
  ({ className, label, error, helperText, ...props }, ref) => (
    <div className="flex flex-col gap-2">
      ...
      <input
        ref={ref}
        className={clsx(
          'px-4 py-2 rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-50 placeholder-slate-500 dark:placeholder-slate-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500',
