...
class Startup(Base):
    ...
    is_verified = Column(Boolean, default=False)
    company_type = Column(String, default="startup")
    company_type_other = Column(String, nullable=True)
    headquarters_city = Column(String, nullable=True)
    state = Column(String, nullable=True)
    official_email = Column(String, nullable=True)
    contact_number = Column(String, nullable=True)
    founder_ceo_name = Column(String, nullable=True)
    auth_rep_name = Column(String, nullable=True)
    auth_rep_designation = Column(String, nullable=True)
    ...
    incorporation_cert_url = Column(String, nullable=True)
    relevant_doc_url = Column(String, nullable=True)
...
class Challenge(Base):
    ...
    problem_code = Column(String, unique=True, index=True, nullable=True)
    department_or_ministry = Column(String, nullable=True)
    contact_person_name = Column(String, nullable=True)
    contact_phone = Column(String, nullable=True)
    contact_email = Column(String, nullable=True)
    target_beneficiaries = Column(JSON, nullable=True)
    target_beneficiaries_other = Column(String, nullable=True)
    technical_requirements = Column(JSON, nullable=True)
    technical_requirements_other = Column(String, nullable=True)
    created_at = Column(DateTime, default=datetime.utcnow)
    updated_at = Column(DateTime, default=datetime.utcnow, onupdate=datetime.utcnow)
